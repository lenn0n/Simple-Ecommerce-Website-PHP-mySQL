...
if(isset($_POST["type"]) && $_POST["type"]=='add' && $_POST["product_qty"]>0)
{
   ...
   $statement = mysql_query("SELECT * FROM products WHERE product_code = '$_POST[product_code]'");
	while($row = mysql_fetch_array($statement)){
        ...
        $new_product["product_img"] = $row[product_img_url];
		...
		// SESSION muna, BAGO yung PRIMARY bago ang value ng array.
    }
